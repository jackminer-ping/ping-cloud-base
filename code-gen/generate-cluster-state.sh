...
#                                  |                                                    |
# EXTERNAL_INGRESS_ENABLED         | List of comma seperated ping apps(pingaccess,      |
#                                  | pingaccess-was,pingdirectory,pingdelegator,        | No defaults
#                                  | pingfederate) for which you can enable             |
#                                  | external ingress                                   |
#                                  |                                                    |
